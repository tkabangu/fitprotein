 ...
 */
final class Version20200817100424 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD filename VARCHAR(255) NOT NULL, ADD image_file VARCHAR(255) NOT NULL, DROP created_at, DROP updated_at');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL, DROP filename, DROP image_file');
    }
}
